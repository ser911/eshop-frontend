    ...
    this.route.params.subscribe((params) => {
      if (params.id) {
        ...
        this.variantsService.getVariant(params.id).subscribe((variant) => {
          this.variantForm.product.setValue(variant.product.id);
          this.variantForm.color.setValue(variant.color);
          this.variantForm.size.setValue(variant.size);
          this.variantForm.inventory.setValue(variant.inventory);
          this.imageDisplay = variant.image;
          this.variantForm.image.setValidators([]);
          this.variantForm.image.updateValueAndValidity();
          // this.variantForm.images.setValidators([]);
          // this.variantForm.images.updateValueAndValidity();
        });
      }
    });
  }
